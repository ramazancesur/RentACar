<%@ Page Title="" Language="C#" MasterPageFile="~/otokiralama.master" AutoEventWireup="true" CodeFile="Duyuru-Sil.aspx.cs" Inherits="Duyuru_Sil" %>
        ...
        <ItemTemplate>
            <table style="width:100%;">
                <tr>
                    ...
                    <td>
                        <asp:Button ID="btnHaberGor" runat="server" Text="Sil" CommandArgument='<%# Eval("haber_id") %>' OnCommand="btnHaberGor_Command"  />
                    </td>
                </tr>
            </table>
        </ItemTemplate>
